...
describe('Route-mc module', function() {
  ...
  describe('Bad Request GET, invalid get schema', () => {
    describe('GET /imBad', () => {
      it('should respond with a status 404', () => {
        return superagent.get(':3000/api/v1/imBad')
          .catch(err => {
  ...
  describe('Valid Request to the GET API', () => {
    describe('GET /mc', () => {
      it('should respond with a status 200', () => {
        return superagent.get(':3000/api/v1/mc')
          .then(res => {
  ...
  describe('Bad Request POST, missing ID', () => {
    describe('POST /mc', () => {
      it('should respond with a status 404', () => {
        return superagent.post(':3000/api/v1/mc')
          .catch(err => {
            expect(err.status).toBe(404)
          })
      })
  ...
  describe('Bad Request PUT, no ID', () => {
    describe('PUT /mc', () => {
      it('should respond with a status 404', () => {
        return superagent.put(':3000/api/v1/mc')
          .catch(err => {
            expect(err.status).toBe(404)
          })
      })
  ...
  describe('Bad Request DELETE, no ID', () => {
    describe('DELETE /mc', () => {
      it('should respond with a status 404', () => {
        return superagent.delete(':3000/api/v1/mc')
          .catch(err => {
            expect(err.status).toBe(404)
          })
      })
  ...
  describe('Valid Request to the DELETE API', () => {
    describe('DELETE /mc', () => {
      it('should respond with a status 204', () => {
        return superagent.delete(':3000/api/v1/mc/5a725c8d20af541da254b808')
